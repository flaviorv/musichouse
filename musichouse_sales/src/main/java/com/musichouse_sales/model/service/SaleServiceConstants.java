...
public class SaleServiceConstants {
    ...
    public static final String OPEN_SALE_ALREADY_EXISTS = "There is already an open sale";
    public static final String OPEN_STATUS_EXCEPTION = "This sale does not have the OPEN status";
}
